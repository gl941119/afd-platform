<template>
    <div class="records">
        <div class="records_notic" v-if="totalFlowDatas.length===0">
            <div>暂无数据</div>
        </div>
        <div class="records_titleBox" ref="revenueWrapper">
            <mt-loadmore :bottom-method="learnMoreItem" @bottom-status-change="handleBottomChange" :bottom-all-loaded="allLoaded" ref="revenueLoadmore">
                <div class="records_titleBox_title" v-for="(item, index) in totalFlowDatas" :key="index">
                    <div class="records_titleBox_title_info">
                        {{item.createTime}}
                    </div>
                    <div class="records_titleBox_title_info">{{item.desc}}</div>
                    <div class="records_titleBox_title_info">
                ...
                <div slot="bottom" class="records-bottom" v-show="hide">
